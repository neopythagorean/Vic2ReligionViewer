...
public class Viewer {
	...
	public static void makeAndDisplay()  {
			...
			public void actionPerformed(ActionEvent e) {
				...
				SwingWorker sw = new SwingWorker() {
					protected Object doInBackground() throws Exception {
						...
						Driver.defines = new File(mapDir.getText() + (mapDir.getText().endsWith(fs)?"":fs) + "definition.csv");
						Driver.mapFile = new File(mapDir.getText() + (mapDir.getText().endsWith(fs)?"":fs) + "provinces.bmp");
		...
		//mainPanel.add(pbar, BorderLayout.AFTER_LAST_LINE);
